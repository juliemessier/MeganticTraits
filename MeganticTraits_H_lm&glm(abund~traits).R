...
#===========================================================
    ...
    # 1.1 Scatterplots - pairwise interactions? ####
    #----
    ...
    # 1.2 Tree models - non-linearities ####
    #----
...
#===========================================================
 ...
 # E) fit model without outliers ####
  ...
  # 2.5 glm, gamma link fct - Meets assumption, but model not significant without outliers ####
  #=========================================#
